...
// RepositoryStats represents statistics about repositories
...
// FilterType represents the type of repository filter
type FilterType int
...
// CloneProgress represents the progress of cloning operations
