...
// StatsDisplayModel represents the Bubbletea model for displaying repository statistics
...
// NewStatsDisplayModel creates a new stats display model
...
func (m *StatsDisplayModel) View() string {
	...
	// Repository counts with visual bars
...
// IsDone returns whether the display is complete
func (m *StatsDisplayModel) IsDone() bool {
	return m.done
}

// ShowRepositoryStats displays repository statistics with Bubbletea
